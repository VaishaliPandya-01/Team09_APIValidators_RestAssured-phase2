...
public class UserPost_Payload {
	...
	private List<UserRoleMaps_Payload> userRoleMaps;
	...
	public List<UserRoleMaps_Payload> getUserRoleMaps() {
		return userRoleMaps;
	}
	public void setUserRoleMaps(List<UserRoleMaps_Payload> userRoleMaps) {
